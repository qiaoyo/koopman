...
if __name__=="__main__":
    ...
    train_slide_dataset=prepare_data_with_folder(folder=18,window=window,return_split=False)
    test_slide_dataset=prepare_data_with_folder(folder=19,window=window,return_split=False)
    ...
    checkpoint_path = os.path.join(save_dir, 'best_model_0502.pth')
